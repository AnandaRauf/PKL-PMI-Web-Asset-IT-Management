...
class Scan extends Ci_Controller
{
    ...
    public function index()
    {
        ...
        //     <p><strong><i class='icon-ok'></i>Data</strong> Berhasil Scan...!</p></div>";    
        //     $this->template->load('layoutbackend', 'scan/v_scan', $data); 
        // }
        // else{
        //     $data['message'] = "";
        //     $this->template->load('layoutbackend', 'scan/v_scan', $data);
        // }   
        $this->template->load('layoutbackend', 'scan/v_scan');
    }
