...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            ...
            ?>
            <?php echo form_open('jenis/insert', array('class' => 'form-horizontal', 'id' => 'jvalidate')) ?>

                <div class="form-group">
                    <p class="col-sm-2 text-left">Nama Jenis </p>

                    <div class="col-sm-10">
                        <input type="text" name="nama_jenis" class="form-control" placeholder="Nama Jenis" value="<?php echo set_value('nama_jenis'); ?>">
                    </div>
                </div>
